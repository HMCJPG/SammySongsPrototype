export default function GrammarAndVocabularyPage() {
    return (
        <main style={{ padding: '80px 20px', minHeight: '100vh', textAlign: 'center', backgroundColor: 'var(--primary-bg)' }}>
            <div className="container" style={{ maxWidth: '800px' }}>
                <h2 style={{ fontSize: '3rem', color: 'var(--text-dark)', marginBottom: '20px', fontWeight: 900 }}>Grammar and vocabulary</h2>
                <p style={{ fontSize: '1.25rem', color: '#666', marginBottom: '50px', lineHeight: '1.6' }}>
                    This sub-section of BedtimeMoneyHabits.com is coming soon! Check back later for more exciting activities and learning materials.
                </p>
