...
export default function GiveWiselyPage() {
    return (
        <main style={{ padding: '80px 20px', backgroundColor: 'var(--light-bg)', minHeight: '80vh' }}>
            <div className="container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                <h2 style={{ fontSize: '2.5rem', marginBottom: '30px', color: 'var(--text-dark)' }}>Give Wisely!</h2>

                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '30px' }}>
                    {/* Video Player */}
                    <div style={{ flex: '3 1 600px', background: 'white', padding: '20px', borderRadius: '24px', boxShadow: '0 5px 15px rgba(0,0,0,0.1)' }}>
                        <CustomVideoPlayer src="/assets/videos/GiveWisely.mp4" poster="/assets/images/give_wisely_thumbnail.png" />
                    </div>
